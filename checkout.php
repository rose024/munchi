        ...
        <div id="checkout-container">
            <div class="contact-info">
                ...
                <h3>Payments</h3>
                    ...
                    <label for="phone_num">Phone Number:</label>
                    <input type="number" id="phone_num" name="+1 234 567 890" placeholder="+1 234 567 890" required><br>

                    <label for="card_num">Card Number:</label>
                    <input type="number" id="phone_num" name="000 000 0000" placeholder="000 000 0000" required><br>

                    <label for="expiration_date">Expiration Date:</label>
                    <input type="number" id="phone_num" name="mm/yy" placeholder="mm/yy" required>
